...
export class StatRollerApp extends HandlebarsApplicationMixin(ApplicationV2) {
    constructor(actor) {
        ...
        this.actor = actor;
        this.method = game.settings.get("the-professors-stat-o-matic", "rollMethod");
        this.rolledValues = [];
        this.assignments = {
            str: null,
            dex: null,
    ...
    static PARTS = {
        main: {
            template: "modules/the-professors-stat-o-matic/templates/stat-roller.hbs"
        }
    };
    ...
    static async _onConfirmAssignments(event, target) {
        ...
        const storedAssignments = this.actor.getFlag("the-professors-stat-o-matic", "assignments") || {};
        ...
        await this.actor.setFlag("the-professors-stat-o-matic", "assignments", newStoredAssignments);
        await this.actor.setFlag("the-professors-stat-o-matic", "rolled", true);
