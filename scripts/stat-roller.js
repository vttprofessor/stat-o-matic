...
// Init
Hooks.once("init", () => {
    console.log("The Professor's Stat-O-Matic | Initializing...");

    game.settings.register("the-professors-stat-o-matic", "rollMethod", {
...
Hooks.on("renderSettingsConfig", (app, html, data) => {
    ...
    const input = $html.find('select[name="the-professors-stat-o-matic.rollMethod"]');
...
Hooks.on("renderCharacterActorSheet", (sheet, html, data) => {
    ...
    if (pillsContainer.length) {
        ...
        const hasAssignments = !!sheet.document.getFlag("the-professors-stat-o-matic", "assignments");
                    ...
                    onClick: () => {
                        Dialog.confirm({
                            ...
                            yes: async () => {
                                ...
                                const storedAssignments = actor.getFlag("the-professors-stat-o-matic", "assignments") || {};
                                const updates = {};
                                ...
                                await actor.unsetFlag("the-professors-stat-o-matic", "assignments");
